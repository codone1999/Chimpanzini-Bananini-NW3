...
<template>
  ...
  <main class="relative min-h-screen flex flex-col justify-center items-center text-center bg-gray-950 overflow-hidden pt-24 pb-32 px-4">
    ...
    <div class="z-10 max-w-2xl">
      ...
      <p class="text-gray-400 text-lg md:text-xl mb-12 animate-fade-in delay-100">
      ...
      <div class="fixed bottom-6 inset-x-0 flex justify-around px-4 md:static md:justify-center md:gap-8">
        <router-link
          :to="{ name: 'ListGallery' }"
          class="itbms-shopnow bg-gradient-to-r from-purple-500 to-indigo-600 hover:opacity-90 text-white px-6 py-3 rounded-xl text-lg font-semibold shadow-lg transition duration-200 ease-in-out animate-fade-up"
        >
          Shop Now
        </router-link>
        ...
        <router-link
          ...
          class="itbms-seller bg-gradient-to-r from-amber-500 to-orange-600 hover:opacity-90 text-white px-7 py-3 rounded-xl text-lg font-semibold shadow-lg transition duration-200 ease-in-out animate-fade-up delay-150"
        >
          Seller
        </router-link>
      </div>
    ...
    <section class="z-10 mt-32 max-w-6xl w-full text-left">
      <h2 class="text-3xl md:text-4xl font-bold mb-12 text-center bg-gradient-to-r from-purple-400 to-indigo-500 bg-clip-text text-transparent animate-fade-in">Why Shop with ITB MShop?</h2>
